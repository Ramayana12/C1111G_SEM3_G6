<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/Admin/masterPageAdmin.Master" AutoEventWireup="true" CodeBehind="DistanceCreate.aspx.cs" Inherits="OPMS_Website.Admin.DistanceCreate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div id="box">
        <h3>Add New Distance Charge</h3>
        <div class="form">
            <fieldset id="personal" class="form">
                <legend class="legend" style="width: 120px">INFORMATION</legend>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Label ID="Label1" runat="server" Text="Distance charge name:"></asp:Label>
                ...
                <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="txtName"
                    ErrorMessage="Distance charge name is not empty" ForeColor="Red">(*)</asp:RequiredFieldValidator>
            ...
            <asp:Button ID="btnCreate" runat="server" Text="Create" OnClick="btnCreate_Click" Width="73px" />
                &nbsp;
            <asp:Button ID="btnClose" runat="server" Text="Close" PostBackUrl="~/Admin/DistanceManagement.aspx" CausesValidation="False" /><br />
                <br />
            </fieldset>
        </div>
    </div>
